  ...
  <div class="main-wrap">
    ...
    <div class="product-page wrap">
      ...
      <div class="brands wrap">
        <a href="#" class="brand-item bi6"><img src="img/brands/bradken.gif"><span><h3>Bradken</h3><p>Ходовая группа для карьерной техники, режущий инструмент</p></span></a>
        <a href="#" class="brand-item bi5"><img src="img/brands/esco.jpg"><span><h3>ESCO</h3><p>Коронки, адаптера, межзубьевая защита для карьерной техники</p></span></a>
      </div>
    </div>
...
export default {
  ...
  head: {
    title: 'Режущий инструмент — ООО «Тепарк»'
  },
